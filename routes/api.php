...
use App\Http\Middleware\ForwardRequestToHostMiddleware;
use App\Http\Middleware\JsonResourceWithoutWrappingMiddleware;
...
Route::middleware([
    ...
    Route::get('folders', [ \App\Http\Controllers\FoldersController::class, 'index'])->name('log-viewer.folders');
