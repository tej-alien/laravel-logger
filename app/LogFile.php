...
use App\Exceptions\InvalidRegularExpression;
use App\Facades\LogViewer;
use App\Logs\LogType;
use App\Readers\LogReaderInterface;
use App\Utils\Utils;
...
class LogFile
{
    use \App\Concerns\LogFile\CanCacheData;
    use \App\Concerns\LogFile\HasMetadata;
