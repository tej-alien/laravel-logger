...
class LogIndex
{
    use \App\Concerns\LogIndex\CanCacheIndex;
    use \App\Concerns\LogIndex\CanFilterIndex;
    use \App\Concerns\LogIndex\CanIterateIndex;
    use \App\Concerns\LogIndex\CanSplitIndexIntoChunks;
    use \App\Concerns\LogIndex\HasMetadata;
    use \App\Concerns\LogIndex\PreservesIndexingProgress;
