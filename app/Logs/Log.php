...
use App\LogLevels\LaravelLogLevel;
...
class Log
{
    ...
    /** @var string|LevelInterface The class which defines the severities found on these logs. Should implement the \App\LogLevels\LevelInterface interface */
